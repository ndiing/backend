...
<dt><a href="#ObjectFile">ObjectFile</a></dt>
<dd><p>Kelas ObjectFile untuk membaca dan menulis file objek JSON.</p>
</dd>
...
-   [ObjectFile](#ObjectFile)
    -   [.read(pathname, [data])](#ObjectFile.read) ⇒ <code>Object</code>
    -   [.write(pathname, data)](#ObjectFile.write)

<a name="ObjectFile.read"></a>

### ObjectFile.read(pathname, [data]) ⇒ <code>Object</code>

Membaca data dari file JSON.

**Kind**: static method of [<code>ObjectFile</code>](#ObjectFile)  
**Returns**: <code>Object</code> - - Data yang dibaca dari file JSON, atau data default jika terjadi kesalahan.

| Param    | Type                | Default         | Description                                                               |
| -------- | ------------------- | --------------- | ------------------------------------------------------------------------- |
| pathname | <code>string</code> |                 | Jalur ke file yang ingin dibaca.                                          |
| [data]   | <code>Object</code> | <code>{}</code> | Data default yang akan dikembalikan jika file tidak ada atau tidak valid. |

<a name="ObjectFile.write"></a>

### ObjectFile.write(pathname, data)
...
| Param    | Type                | Description                             |
| -------- | ------------------- | --------------------------------------- |
| pathname | <code>string</code> | Jalur ke file tempat data akan ditulis. |
| data     | <code>Object</code> | Data yang akan ditulis ke file.         |
