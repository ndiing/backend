...
// const { default: makeWASocket, AnyMessageContent, delay, DisconnectReason, fetchLatestBaileysVersion, getAggregateVotesInPollMessage, makeCacheableSignalKeyStore, makeInMemoryStore, PHONENUMBER_MCC, proto, useMultiFileAuthState, WAMessageContent, WAMessageKey } = require("@whiskeysockets/baileys");
// const { default: MAIN_LOGGER } = require("@whiskeysockets/baileys/lib/Utils/logger");
...
//                 if (qr) {
//                     const url = new URL(`https://chart.googleapis.com/chart?cht=qr&chs=256x256&chl=`);
//                     url.searchParams.set("chl", qr);
