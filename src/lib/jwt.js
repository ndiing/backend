...
/* 
buat semua penanganan untuk sign& verify semua alg
*/
...
const signer = {
    ...
    es256: (secret, data) => {
        return crypto.sign(
            'sha256',
            data,
            {key: secret,dsaEncoding:'ieee-p1363'},
        ).toString('base64url')
    },
    es384: (secret, data) => {
        return crypto.sign(
    ...
    ps256: (secret, data) => {
        return crypto.sign(
            'sha256',
            data,
            {key: secret,padding:crypto.constants.RSA_PKCS1_PSS_PADDING}
        ).toString('base64url')
    },
    ps384: (secret, data) => {
        return crypto.sign(
...
// const token = encode(header, payload, secret)
...
// for(const alg in N){
//     // console.log(alg)
//     let {token,secret,privateKey} = (N[alg])
//     // console.log(token,secret||privateKey)
//     let key = secret||privateKey
//     let payload = decode(token,key)
//     // all decode passed
//     // console.log(payload)
//     // test kembalikan ke token
//     // console.log(alg)
//     // console.log(encode({alg:alg.toUpperCase(),type:'JWT'},payload,key))
//     // console.log()
//     // test token online
//     // break
// }
...
// // passed
// console.log(decode('eyJhbGciOiJQUzUxMiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.J5W09-rNx0pt5_HBiydR-vOluS6oD-RpYNa8PVWwMcBDQSXiw6-EPW8iSsalXPspGj3ouQjAnOP_4-zrlUUlvUIt2T79XyNeiKuooyIFvka3Y5NnGiOUBHWvWcWp4RcQFMBrZkHtJM23sB5D7Wxjx0-HFeNk-Y3UJgeJVhg5NaWXypLkC4y0ADrUBfGAxhvGdRdULZivfvzuVtv6AzW6NRuEE6DM9xpoWX_4here-yvLS2YPiBTZ8xbB3axdM99LhES-n52lVkiX5AWg2JJkEROZzLMpaacA_xlbUz_zbIaOaoqk8gB5oO7kI6sZej3QAdGigQy-hXiRnW_L98d4GQ',`-----BEGIN PRIVATE KEY-----
// MIIEvwIBADANBgkqhkiG9w0BAQEFAASCBKkwggSlAgEAAoIBAQC7VJTUt9Us8cKj
// MzEfYyjiWA4R4/M2bS1GB4t7NXp98C3SC6dVMvDuictGeurT8jNbvJZHtCSuYEvu
// NMoSfm76oqFvAp8Gy0iz5sxjZmSnXyCdPEovGhLa0VzMaQ8s+CLOyS56YyCFGeJZ
// qgtzJ6GR3eqoYSW9b9UMvkBpZODSctWSNGj3P7jRFDO5VoTwCQAWbFnOjDfH5Ulg
