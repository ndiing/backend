...
class DB {
    ...
    multiFilter(array, filterCriteria) {
        return array.filter((item) => filterCriteria.every((criteria) => {
...
// // Usage example
// const db = new DB();
// db.post({_id:1,name:'ndiing'})
// // db.post({_id:1,name:'ndiing'})
// // console.log(db.get({_id:1}));
// db.patch({_id:1,name:'ndiing',email:'ndiing.inc'})
// // console.log(db.get({_id:1}));
// console.log(db.delete({_id:1}));
// // console.log(db.get({_id:1}));
// console.log(db.put({_id:1,name:'ok'}));
// console.log(db.put({_id:1,name:'ok'}));
// console.log(db.put({_id:1,name:'ok'}));
// console.log(db.get({_id:1}));
